...
namespace test
{
    ...
    public class Stepdefs
    {
        ...
        {
            var txn = new Transaction(pk, fee, fv, lv, note, amt, to, gen, gh)
            {
        ...
        //    Ed25519PublicKey []
        //    addrlist = new Ed25519PublicKey[addrs.length];
        ...
        //{
        //    assertThat(acl.transactions(addresses.get(0), 1), acl.getStatus().LastRound, null, null, 10)).getTransactions())
        ...
        //{
        //    assertThat(acl.transactions(addresses.get(0), null, null, null, null, 10)).getTransactions())
        //                .isInstanceOf(List.class);
        ...
        //{
        //    assertThat(acl.transactions(addresses.get(0), null, null, LocalDate.now(), LocalDate.now(), 10)).getTransactions())
        //                .isInstanceOf(List.class);
        ...
        //{
        //    assertThat(acl.getPendingTransactions(10)).getTruncatedTxns())
        ...
        //{
        //    assertThat(microalgos).isEqualTo(ma));
        //}
        ...
        //{
        //    assertThat(acl.transactions(addresses.get(0), null, null, null, null, cnt)).getTransactions())
        //                .isInstanceOf(List.class);
        ...
        //    assertThat(holding.getAmount()).isEqualTo(expectedBal));
        //}
        ...
        //    assertThat(ddr.txns.Count).isGreaterThan(0);
        ...
        //}
        //assertThat(msgs.Count).isGreaterThan(0);
        //assertThat(msgs.get(msgs.Count - 1)).isEqualTo(result);
        //    }
    }
}
