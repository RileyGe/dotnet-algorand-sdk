...
namespace Algorand.Kmd.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WalletInfoRequest :  IEquatable<WalletInfoRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="WalletInfoRequest" /> class.
        /// </summary>
        /// <param name="walletHandleToken">walletHandleToken.</param>
        public WalletInfoRequest(string walletHandleToken = default(string))
        {
        ...
        {
            return this.Equals(input as WalletInfoRequest);
        }

        /// <summary>
        /// Returns true if WalletInfoRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of WalletInfoRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WalletInfoRequest input)
        {
            if (input == null)
                return false;
