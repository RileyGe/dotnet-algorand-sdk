...
namespace Algorand.Kmd.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExportMultisigRequest :  IEquatable<ExportMultisigRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportMultisigRequest" /> class.
        /// </summary>
        /// <param name="address">address.</param>
        /// <param name="walletHandleToken">walletHandleToken.</param>
        /// <param name="walletPassword">walletPassword.</param>
        public ExportMultisigRequest(Address address = default(Address), string walletHandleToken = default(string), string walletPassword = default(string))
        {
        ...
        {
            return this.Equals(input as ExportMultisigRequest);
        }

        /// <summary>
        /// Returns true if ExportMultisigRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportMultisigRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportMultisigRequest input)
        {
            if (input == null)
                return false;
