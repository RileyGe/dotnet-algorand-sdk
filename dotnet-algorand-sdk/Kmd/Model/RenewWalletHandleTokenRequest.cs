...
namespace Algorand.Kmd.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RenewWalletHandleTokenRequest :  IEquatable<RenewWalletHandleTokenRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RenewWalletHandleTokenRequest" /> class.
        /// </summary>
        /// <param name="walletHandleToken">walletHandleToken.</param>
        public RenewWalletHandleTokenRequest(string walletHandleToken = default(string))
        {
        ...
        {
            return this.Equals(input as RenewWalletHandleTokenRequest);
        }

        /// <summary>
        /// Returns true if RenewWalletHandleTokenRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of RenewWalletHandleTokenRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RenewWalletHandleTokenRequest input)
        {
            if (input == null)
                return false;
