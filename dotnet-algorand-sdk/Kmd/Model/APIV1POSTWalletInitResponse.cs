...
namespace Algorand.Kmd.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class APIV1POSTWalletInitResponse :  IEquatable<APIV1POSTWalletInitResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APIV1POSTWalletInitResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="message">message.</param>
        /// <param name="walletHandleToken">walletHandleToken.</param>
        public APIV1POSTWalletInitResponse(bool? error = default(bool?), string message = default(string), string walletHandleToken = default(string))
        {
            this.Error = error;
        ...
        {
            return this.Equals(input as APIV1POSTWalletInitResponse);
        }

        /// <summary>
        /// Returns true if APIV1POSTWalletInitResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of APIV1POSTWalletInitResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(APIV1POSTWalletInitResponse input)
        {
            if (input == null)
                return false;
