...
namespace Algorand.Kmd.Model
{
        ...
        public partial class TxType :  IEquatable<TxType>, IValidatableObject
    {
        ...
        {
            return this.Equals(input as TxType);
        }

        /// <summary>
        /// Returns true if TxType instances are equal
        /// </summary>
        /// <param name="input">Instance of TxType to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TxType input)
        {
            if (input == null)
                return false;
