...
namespace Algorand.Kmd.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ExportKeyRequest :  IEquatable<ExportKeyRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ExportKeyRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as ExportKeyRequest);
        }

        /// <summary>
        /// Returns true if ExportKeyRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ExportKeyRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ExportKeyRequest input)
        {
            if (input == null)
                return false;
