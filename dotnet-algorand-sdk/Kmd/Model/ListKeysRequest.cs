...
namespace Algorand.Kmd.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ListKeysRequest :  IEquatable<ListKeysRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListKeysRequest" /> class.
        /// </summary>
        /// <param name="walletHandleToken">walletHandleToken.</param>
        public ListKeysRequest(string walletHandleToken = default(string))
        {
        ...
        /// <summary>
        /// Returns true if ListKeysRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ListKeysRequest to be compared</param>
        /// <returns>Boolean</returns>
