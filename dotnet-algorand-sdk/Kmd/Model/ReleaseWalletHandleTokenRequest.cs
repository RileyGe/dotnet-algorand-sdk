...
namespace Algorand.Kmd.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReleaseWalletHandleTokenRequest :  IEquatable<ReleaseWalletHandleTokenRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseWalletHandleTokenRequest" /> class.
        /// </summary>
        /// <param name="walletHandleToken">walletHandleToken.</param>
        public ReleaseWalletHandleTokenRequest(string walletHandleToken = default(string))
        {
        ...
        {
            return this.Equals(input as ReleaseWalletHandleTokenRequest);
        }

        /// <summary>
        /// Returns true if ReleaseWalletHandleTokenRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ReleaseWalletHandleTokenRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReleaseWalletHandleTokenRequest input)
        {
            if (input == null)
                return false;
