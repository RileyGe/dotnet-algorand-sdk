...
namespace Algorand.Kmd.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SignTransactionRequest :  IEquatable<SignTransactionRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SignTransactionRequest" /> class.
        /// </summary>
        ...
        {
            return this.Equals(input as SignTransactionRequest);
        }

        /// <summary>
        /// Returns true if SignTransactionRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of SignTransactionRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SignTransactionRequest input)
        {
            if (input == null)
                return false;
