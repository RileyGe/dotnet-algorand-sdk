...
namespace Algorand.Kmd.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class APIV1POSTWalletRenewResponse :  IEquatable<APIV1POSTWalletRenewResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="APIV1POSTWalletRenewResponse" /> class.
        /// </summary>
        /// <param name="error">error.</param>
        /// <param name="message">message.</param>
        /// <param name="walletHandle">walletHandle.</param>
        public APIV1POSTWalletRenewResponse(bool? error = default(bool?), string message = default(string), APIV1WalletHandle walletHandle = default(APIV1WalletHandle))
        {
            this.Error = error;
        ...
        {
            return this.Equals(input as APIV1POSTWalletRenewResponse);
        }

        /// <summary>
        /// Returns true if APIV1POSTWalletRenewResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of APIV1POSTWalletRenewResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(APIV1POSTWalletRenewResponse input)
        {
            if (input == null)
                return false;
