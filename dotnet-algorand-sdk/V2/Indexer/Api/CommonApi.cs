...
namespace Algorand.V2.Indexer.Api
{
        ...
        public partial class CommonApi : ICommonApi
    {
        ...
        /// <returns></returns>
        public CommonApi(Algorand.V2.Indexer.Client.Configuration configuration = null)
        {
        ...
        {
             ApiResponse<HealthCheck> localVarResponse = MakeHealthCheckWithHttpInfo();
        ...
        public ApiResponse< HealthCheck > MakeHealthCheckWithHttpInfo ()
        {
            ...
            {
                Exception exception = ExceptionFactory("MakeHealthCheck", localVarResponse);
        ...
        {
             ApiResponse<HealthCheck> localVarResponse = await MakeHealthCheckAsyncWithHttpInfo();
             return localVarResponse.Data;
