...
namespace Algorand.V2.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class TransactionAssetConfig :  IEquatable<TransactionAssetConfig>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TransactionAssetConfig" /> class.
        /// </summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class TransactionAssetConfig {\n");
        ...
        {
            return this.Equals(input as TransactionAssetConfig);
        }

        /// <summary>
        /// Returns true if TransactionAssetConfig instances are equal
        /// </summary>
        /// <param name="input">Instance of TransactionAssetConfig to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TransactionAssetConfig input)
        {
            if (input == null)
                return false;
