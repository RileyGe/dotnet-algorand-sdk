...
namespace Algorand.V2.Model
{
    ...
    public partial class PostTransactionsResponse :  IEquatable<PostTransactionsResponse>, IValidatableObject
    {
        ...
        protected PostTransactionsResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PostTransactionsResponse" /> class.
        /// </summary>
        /// <param name="txId">encoding of the transaction hash. (required).</param>
        public PostTransactionsResponse(string txId = default(string))
        {
        ...
        /// </summary>
        /// <value>encoding of the transaction hash.</value>
        ...
        {
            return this.Equals(input as PostTransactionsResponse);
        }
