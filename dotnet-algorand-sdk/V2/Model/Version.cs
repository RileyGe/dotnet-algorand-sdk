...
namespace Algorand.V2.Model
{
    ...
    public partial class Version :  IEquatable<Version>, IValidatableObject
    {
        ...
        public Version(BuildVersion build = default(BuildVersion), byte[] genesisHashB64 = default(byte[]), string genesisId = default(string), List<string> versions = default(List<string>))
        {
        ...
        public byte[] GenesisHashB64 { get; set; }
