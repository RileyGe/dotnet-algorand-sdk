...
namespace Algorand.V2.Algod.Model
{
        ...
        public partial class ApplicationLocalState :  IEquatable<ApplicationLocalState>, IValidatableObject
    {
        ...
        public ApplicationLocalState(int? id = default(int?), List keyValue = default(List), ApplicationStateSchema schema = default(ApplicationStateSchema))
        {
