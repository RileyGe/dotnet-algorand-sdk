...
namespace Algorand.V2.Algod.Model
{
    ...
    public partial class ApplicationLocalState :  IEquatable<ApplicationLocalState>, IValidatableObject
    {
        ...
        public ApplicationLocalState(int? id = default(int?), ApplicationStateSchema schema = default(ApplicationStateSchema), TealKeyValueStore keyValue = default(TealKeyValueStore))
        {
