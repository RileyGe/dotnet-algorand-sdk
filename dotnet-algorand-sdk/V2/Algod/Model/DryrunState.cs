...
namespace Algorand.V2.Algod.Model
{
        ...
        public partial class DryrunState :  IEquatable<DryrunState>, IValidatableObject
    {
        ...
        public DryrunState(string error = default(string), int? line = default(int?), int? pc = default(int?), List<TealValue> scratch = default(List<TealValue>), List<TealValue> stack = default(List<TealValue>))
        {
