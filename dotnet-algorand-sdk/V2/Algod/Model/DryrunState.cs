...
namespace Algorand.V2.Algod.Model
{
    ...
    public partial class DryrunState :  IEquatable<DryrunState>, IValidatableObject
    {
        ...
        public DryrunState(int? line = default(int?), int? pc = default(int?), List<TealValue> stack = default(List<TealValue>), List<TealValue> scratch = default(List<TealValue>), string error = default(string))
        {
