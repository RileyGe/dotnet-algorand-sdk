...
namespace Algorand.V2.Algod.Model
{
    ...
    public partial class DryrunRequest :  IEquatable<DryrunRequest>, IValidatableObject
    {
        ...
        public DryrunRequest(List<string> txns = default(List<string>), List<Account> accounts = default(List<Account>), List<Application> apps = default(List<Application>), string protocolVersion = default(string), int? round = default(int?), long? latestTimestamp = default(long?), List<DryrunSource> sources = default(List<DryrunSource>))
        {
