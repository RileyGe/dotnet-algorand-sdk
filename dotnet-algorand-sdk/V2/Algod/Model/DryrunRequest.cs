...
namespace Algorand.V2.Algod.Model
{
        ...
        public partial class DryrunRequest :  IEquatable<DryrunRequest>, IValidatableObject
    {
        ...
        public DryrunRequest(List<Account> accounts = default(List<Account>), List<Application> apps = default(List<Application>), long? latestTimestamp = default(long?), string protocolVersion = default(string), ulong? round = default, List<DryrunSource> sources = default(List<DryrunSource>), List<string> txns = default(List<string>))
        {
