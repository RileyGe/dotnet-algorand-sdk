...
namespace Algorand.V2.Algod.Model
{
    ...
    public partial class Account :  IEquatable<Account>, IValidatableObject
    {
        ...
        public Account(string address = default(string), int? amount = default(int?), int? amountWithoutPendingRewards = default(int?), List<ApplicationLocalState> appsLocalState = default(List<ApplicationLocalState>), ApplicationStateSchema appsTotalSchema = default(ApplicationStateSchema), List<AssetHolding> assets = default(List<AssetHolding>), List<Application> createdApps = default(List<Application>), List<Asset> createdAssets = default(List<Asset>), AccountParticipation participation = default(AccountParticipation), int? pendingRewards = default(int?), int? rewardBase = default(int?), int? rewards = default(int?), int? round = default(int?), string status = default(string), SigTypeEnum? sigType = default(SigTypeEnum?), string authAddr = default(string))
        {
