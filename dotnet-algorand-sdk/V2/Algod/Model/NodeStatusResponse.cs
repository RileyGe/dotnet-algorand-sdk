...
namespace Algorand.V2.Algod.Model
{
        ...
        public partial class NodeStatusResponse :  IEquatable<NodeStatusResponse>, IValidatableObject
    {
        ...
        public NodeStatusResponse(string catchpoint = default(string), int? catchpointAcquiredBlocks = default(int?), int? catchpointProcessedAccounts = default(int?), int? catchpointTotalAccounts = default(int?), int? catchpointTotalBlocks = default(int?), int? catchupTime = default(int?), string lastCatchpoint = default(string), int? lastRound = default(int?), string lastVersion = default(string), string nextVersion = default(string), int? nextVersionRound = default(int?), bool? nextVersionSupported = default(bool?), bool? stoppedAtUnsupportedRound = default(bool?), int? timeSinceLastRound = default(int?))
        {
