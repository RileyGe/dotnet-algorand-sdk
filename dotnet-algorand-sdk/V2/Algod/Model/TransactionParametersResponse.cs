...
namespace Algorand.V2.Algod.Model
{
        ...
        public partial class TransactionParametersResponse :  IEquatable<TransactionParametersResponse>, IValidatableObject
    {
        ...
        public TransactionParametersResponse(string consensusVersion = default(string), int? fee = default(int?), byte[] genesisHash = default(byte[]), string genesisId = default(string), int? lastRound = default(int?), int? minFee = default(int?))
        {
