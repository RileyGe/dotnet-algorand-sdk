...
namespace Algorand.V2.Algod.Model
{
        ...
        public partial class AssetParams :  IEquatable<AssetParams>, IValidatableObject
    {
        ...
        public AssetParams(string clawback = default(string), string creator = default(string), int? decimals = default(int?), bool? defaultFrozen = default(bool?), string freeze = default(string), string manager = default(string), byte[] metadataHash = default(byte[]), string name = default(string), string reserve = default(string), ulong? total = default, string unitName = default(string), string url = default(string))
        {
