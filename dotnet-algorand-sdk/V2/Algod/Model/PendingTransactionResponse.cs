...
namespace Algorand.V2.Algod.Model
{
        ...
        public partial class PendingTransactionResponse :  IEquatable<PendingTransactionResponse>, IValidatableObject
    {
        ...
        public PendingTransactionResponse(int? applicationIndex = default(int?), int? assetIndex = default(int?), int? closeRewards = default(int?), int? closingAmount = default(int?), int? confirmedRound = default(int?), List globalStateDelta = default(List), List<AccountStateDelta> localStateDelta = default(List<AccountStateDelta>), string poolError = default(string), int? receiverRewards = default(int?), int? senderRewards = default(int?), Object txn = default(Object))
        {
        ...
        public List GlobalStateDelta { get; set; }
