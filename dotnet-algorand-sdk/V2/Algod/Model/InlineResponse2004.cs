...
namespace Algorand.V2.Algod.Model
{
    ...
    public partial class InlineResponse2004 :  IEquatable<InlineResponse2004>, IValidatableObject
    {
        ...
        public InlineResponse2004(int? catchupTime = default(int?), int? lastRound = default(int?), string lastVersion = default(string), string nextVersion = default(string), int? nextVersionRound = default(int?), bool? nextVersionSupported = default(bool?), bool? stoppedAtUnsupportedRound = default(bool?), int? timeSinceLastRound = default(int?), string lastCatchpoint = default(string), string catchpoint = default(string), int? catchpointTotalAccounts = default(int?), int? catchpointProcessedAccounts = default(int?), int? catchpointTotalBlocks = default(int?), int? catchpointAcquiredBlocks = default(int?))
        {
        ...
        public int? NextVersionRound { get; set; }
